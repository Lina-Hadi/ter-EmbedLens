...
def main():
    ...
    np.save("./data/processed/embeddings_resnet_umap.npy", embeddings)
    np.save("./data/processed/labels_resnet_umap.npy", labels)
    ...
    np.save("./data/processed/coords_2d_resnet_umap.npy", coords_2d)
    ...
    with open("./data/processed/resnet_umap_metrics.txt", "w", encoding="utf-8") as f:
        f.write("===== METRIQUES ResNet50 + UMAP =====\n")
    ...
    plt.title("CIFAR-10 - UMAP 2D (ResNet50 embeddings)")
    plt.xlabel("UMAP 1")
    plt.ylabel("UMAP 2")
    ...
    plt.savefig("./data/processed/resnet_umap_plot_with_metrics.png", dpi=150)
    plt.show()

    print("Plot sauvegardé dans ./data/processed/resnet_umap_plot_with_metrics.png")
    print("Métriques sauvegardées dans ./data/processed/resnet_umap_metrics.txt")
