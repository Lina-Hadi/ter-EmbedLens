...
def main():
    ...
    # Sauvegarder aussi les métriques dans un fichier texte
    with open("./data/processed/umap_metrics.txt", "w", encoding="utf-8") as f:
        f.write("===== METRIQUES =====\n")
    ...
    # Affichage à droite (hors du plot)
    plt.figtext(
        0.78, 0.5,
        metrics_text,
        fontsize=10,
    ...
    plt.savefig("./data/processed/umap_plot_with_metrics.png", dpi=150)
    plt.show()

    print("Plot sauvegardé dans ./data/processed/umap_plot_with_metrics.png")
    print("Métriques sauvegardées dans ./data/processed/umap_metrics.txt")
